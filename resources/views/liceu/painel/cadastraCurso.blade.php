            ...
            <div class="four fields">
                <div class="field">
                    ...
                    <select name="unidade" placeholder="Unidade" required>
                        ...
                        <option value="Liceu Digital Tumbira">Liceu Digital Tumbira</option>
                        <option value="Liceu Digital Manaus">Liceu Digital Manaus</option>
                        <option value="Liceu Digital Manacapuru">Liceu Digital Manacapuru</option>
                        <option value="Liceu Digital São Tomé do Mocambo Arari">Liceu Digital São Tomé do Mocambo Arari</option>
                        <option value="Liceu Digital Silves">Liceu Digital Silves</option>
                        <option value="Liceu Digital Parintins (Sede liceu)">Liceu Digital Parintins (Sede liceu)</option>
