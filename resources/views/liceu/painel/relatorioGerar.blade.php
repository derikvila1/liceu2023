...
<script>
    $('#unidade').change(function() {
        ...
        link = 'https://matriculasliceu.cultura.am.gov.br/api/curso?u=' + $('#unidade').val();
        $.ajax({
                method: "get",
                url: link,
                dataType: "json"
        ...
        $('.cursos').change(function() {
            link = 'https://matriculasliceu.cultura.am.gov.br/api/horario?u=' + $('#unidade').val() + '&c=' + $('#cursos').val();
            console.log(link);
            $.ajax({
                    method: "get",
                    url: link,
