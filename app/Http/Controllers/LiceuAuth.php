...
class LiceuAuth extends Controller
{
    ...
    public function index()
    {
        ...
        $result = DB::connection('liceu') ->table('new_table')->select('habilita')->first();
    ...
    public function habilitar(){
        ...
        if($result->habilita == 1){
            ...
            DB::connection('liceu')->table('new_table')->where('habilita',1)->update(['habilita'=>0]);
           
        }
        else
        DB::connection('liceu')->table('new_table')->where('habilita',0)->update(['habilita'=>1]);
    ...
    public function deletaInscrito($uuid)
    {
        ...
        $cursos =    DB::connection('liceu')->table('inscricao')->where('uuid', $uuid)->first();
